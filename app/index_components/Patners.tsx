...
const Patners = () => {
  return (
    <div className="flex justify-center">
      <div className="flex overflow-hidden space-x-16 group w-10/12 lg:w-8/12">
        <div className="flex space-x-4 lg:space-x-16 animate-loop-scroll group-hover:paused">
          <img
            loading="lazy"
