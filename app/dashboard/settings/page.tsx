...
const Settings = () => {
  return (
    <div className="p-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 max-w-270">
        <ProfileForm />
        <Card className="lg:col-span-2 shadow-md dark:shadow-slate-500 h-fit">
          <CardHeader>
            <CardTitle>Your photo</CardTitle>
            <CardDescription>Upload you profile information</CardDescription>
          </CardHeader>
          <CardContent>
            <form action="#">
