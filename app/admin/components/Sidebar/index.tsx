...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={clsx(
        `absolute left-0 top-0 z-9999 flex h-screen w-72.5 lg:w-2/12 flex-col overflow-y-hidden z-50 bg-accent`,
        "duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 pt-5",
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <UserIcon className="fill-current" width="18" height="18" />
                  Profile
                </Link>
              </li>
              {/* <!-- Menu Item Profile --> */}
